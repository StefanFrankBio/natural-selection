...
find $ALIGN_DIR -type f | xargs --max-args=1 --replace=1 --max-procs=$THREADS python scripts/variant_record.py --alignment 1 --reference $REFERENCE --variants $VARIANT_DIR --error $ERR_DIR
